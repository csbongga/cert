-- ============================================================
--  ระบบออกใบประกาศออนไลน์ - โครงสร้างฐานข้อมูล (สำหรับ Shared Hosting)
--  วิธีใช้:
--   1) สร้างฐานข้อมูล + ผู้ใช้ฐานข้อมูลใน cPanel (เมนู MySQL Databases) ก่อน
--   2) เข้า phpMyAdmin เลือกฐานข้อมูลนั้น แล้ว Import ไฟล์นี้
--  (ไฟล์นี้สร้างเฉพาะตาราง ไม่สร้างฐานข้อมูลใหม่ เพราะ cPanel สร้างให้แล้ว)
-- ============================================================
